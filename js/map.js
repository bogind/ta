...
toggle3d = function(){
    if(currentDim == "3d"){
        ...
        currentDim = "2d"
        dim.innerHTML = "<img src='./css/img/threeD.png' height='18' width='25' />"
    }else{
        dim = document.getElementById("dim");
        dim.classList.remove("active");
        dim.classList.add("button");
        map.touchZoomRotate.enable();
        map.dragRotate.enable();
        currentDim = "3d"
        dim.innerHTML = "<img src='./css/img/twoD.png' height='18' width='25' />"
    }
}
